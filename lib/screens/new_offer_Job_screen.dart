...
class NewOfferJobScreen extends StatefulWidget {
  const NewOfferJobScreen({super.key});

  @override
  State<NewOfferJobScreen> createState() =>
      _NewOfferJobScreenState('/new_offer');
}

class _NewOfferJobScreenState extends State<NewOfferJobScreen> {
  String? currentPage;
  ...
  _NewOfferJobScreenState(this.currentPage);
  @override
